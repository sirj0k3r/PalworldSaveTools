...
class PalInfoWidget(PalInfoDisplayMixin, PalInfoHandlerMixin, QFrame):
    ...
    def _clear_display(self):
        ...
        self.iv_icon.setIcon(QIcon())
        self.soul_row_icon.setIcon(QIcon())
    ...
    def _build_header(self, parent):
        ...
        if gender_def:
            self.gender_icon.setIcon(QIcon(gender_def))
        self.gender_icon.setStyleSheet('QPushButton { background: transparent; border: 1px solid rgba(255,255,255,0.1); border-radius: 3px; } QPushButton:checked { background: rgba(147,51,234,0.15); border: 1px solid #9333EA; } QPushButton:hover { background: rgba(255,255,255,0.08); } QToolTip { background: rgba(18,20,24,0.98); color: #E2E8F0; border: 1px solid rgba(125,211,252,0.25); border-radius: 6px; padding: 6px 10px; font-size: 11px; }')
        ...
        self.info_fav_btn.setStyleSheet('QPushButton { background: transparent; border: 1px solid rgba(255,255,255,0.1); border-radius: 3px; } QPushButton:checked { background: rgba(251,191,36,0.15); border: 1px solid #FBBF24; } QPushButton:hover { background: rgba(255,255,255,0.08); } QToolTip { background: rgba(18,20,24,0.98); color: #E2E8F0; border: 1px solid rgba(125,211,252,0.25); border-radius: 6px; padding: 6px 10px; font-size: 11px; }')
    ...
    def _build_body(self, parent):
        ...
        self.soul_row_icon = QPushButton()
        self.soul_row_icon.setFixedSize(18, 18)
        self.soul_row_icon.setIconSize(QSize(12, 12))
        srp = _icons._get_ui_icon_pixmap('buildup', 12)
        if srp:
            self.soul_row_icon.setIcon(QIcon(srp))
        self.soul_row_icon.setStyleSheet('QPushButton { background: transparent; border: 1px solid rgba(255,255,255,0.1); border-radius: 3px; } QPushButton:hover { background: rgba(255,255,255,0.08); } QToolTip { background: rgba(18,20,24,0.98); color: #E2E8F0; border: 1px solid rgba(125,211,252,0.25); border-radius: 6px; padding: 6px 10px; font-size: 11px; }')
        self.soul_row_icon.setCursor(Qt.PointingHandCursor)
        self.soul_row_icon.setToolTip(t('edit_pals.max_all_souls'))
        self.soul_row_icon.clicked.connect(self._on_max_souls_click)
